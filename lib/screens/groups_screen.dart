    ...
    return Scaffold(
          ...
          builder: (context, state) {
            if (state is GroupsLoading) {
              ...
              return RefreshIndicator(
                onRefresh: () async {
                  BlocProvider.of<GroupsBloc>(context).add(LoadGroupsEvent()); // ✅ تحديث البيانات عند السحب
                },
                      ...
                      child: ListTile(
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            ...
                            Text("🕒 من ${group.timeFrom ?? "غير محدد"} إلى ${group.timeTo ?? "غير محدد"}"),
                          ],
                        ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          BlocProvider.of<GroupsBloc>(context).add(LoadGroupsEvent());  // ✅ إعادة تحميل البيانات بعد الرجوع
          });
