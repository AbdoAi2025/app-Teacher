...
import 'package:teacher_app/domain/usecases/create_rejoin_request_use_case.dart';
import 'package:teacher_app/domain/usecases/get_sent_rejoin_requests_use_case.dart';

const int _pageSize = 20;

class SeasonRejoinRequestsController extends GetxController {
  final _useCase = GetSentRejoinRequestsUseCase();
  final _createUseCase = CreateRejoinRequestUseCase();

  final RxList<RejoinRequestData> items = <RejoinRequestData>[].obs;
